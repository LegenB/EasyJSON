            ...
            <Info/>
             <div className='sm:mx-2 md:mx-9'>
                <div className=' grid xl:grid-cols-2 gap-y-8 xl:gap-5 xl:gap-y-0'>
                        ...
                        <form className='mt-3 max-h-[500px]  overflow-y-auto '>
                            {Jarray.map((obj, index)=> (
                                <ul key={index} className='flex items-center justify-center '>
                                    ...
                                    <select className='text-zinc-50 bg-slate-600 m-1 p-1 rounded-md  border-2 border-sky-500/95' 
                                    ...
                                    {formState[`type.${index}`] === 'bool' ? (
                                        ...
                                        <input
                                            ...
                                            onChange={onInputChange}
                                            autoComplete="off"
                                            className='text-zinc-50 bg-slate-600 m-1 p-1 rounded-md border-2 border-sky-500/95 w-2/5'
                                        />
                                    )}
                    ...
                    <div className='w-full'>
                        <div className='flex items-center'>
                            <img src={Code} alt=""  className='size-10 mr-2'/>
